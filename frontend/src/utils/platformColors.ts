...
const TEXT_STRONG: Record<Platform, string> = {
  ...
  minimax: 'text-rose-700 dark:text-rose-400',
  opencode_go: 'text-amber-700 dark:text-amber-400',
  composite: 'text-cyan-700 dark:text-cyan-300',
}
...
const TAG_SOFT: Record<Platform, string> = {
  ...
  minimax: 'bg-rose-100 text-rose-600 dark:bg-rose-900/30 dark:text-rose-400',
  opencode_go: 'bg-amber-100 text-amber-600 dark:bg-amber-900/30 dark:text-amber-400',
...
const LABEL_SUBSCRIPTION: Record<Platform, string> = {
  ...
  opencode_go: 'bg-amber-200/60 text-amber-800 dark:bg-amber-800/40 dark:text-amber-300',
