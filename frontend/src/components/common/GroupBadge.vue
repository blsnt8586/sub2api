...
import {
  platformBadgeStandardClass,
  platformBadgeSubscriptionClass,
  platformLabelSubscriptionClass,
...
const labelClass = computed(() => {
  ...
  // 正常状态或无天数：根据平台显示主题色
  return `${base} ${platformLabelSubscriptionClass(props.platform ?? '')}`
})
...
const badgeClass = computed(() =>
  isSubscription.value
    ? platformBadgeSubscriptionClass(props.platform ?? '')
    : platformBadgeStandardClass(props.platform ?? '')
)
</script>
