<template>
  <Teleport to="body">
    <div v-if="show && position && provider">
      ...
      <div
        class="fixed z-[9999] w-48 overflow-hidden rounded-xl bg-white shadow-lg ring-1 ring-black/5 dark:bg-dark-800"
      ...
      >
        <div class="py-1">
          ...
          <button
            ...
            :disabled="detecting"
            class="flex w-full items-center gap-2 px-4 py-2 text-sm hover:bg-gray-100 disabled:opacity-40 dark:hover:bg-dark-700"
          >
