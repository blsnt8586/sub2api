...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'canvas' | 'kimi' | 'zhipu' | 'deepseek' | 'composite'
...
export interface AdminGroup extends Group {
	...
	dynamic_pricing_markup: number
	manual_rate_multiplier: number
	dynamic_source_max_multiplier: number | null
	dynamic_pricing_updated_at: string | null
	dynamic_pricing_status: 'manual' | 'ready' | 'no_accounts' | 'error'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'canvas' | 'kimi' | 'zhipu' | 'deepseek'
