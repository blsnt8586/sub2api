export default {
  ...
  nav: {
    ...
    sub2apiProviders: 'Sub2API Providers',
  },
  ...
  admin: {
    ...
    sub2apiProviders: {
      ...
      description: 'Manage third-party Sub2API instances, auto-link accounts, and optimize rate groups',
      ...
      noProvidersDesc: 'Click "Add Provider" to configure your first Sub2API instance',
      refresh: 'Refresh',

      form: {
        name: 'Provider Name',
        namePlaceholder: 'e.g. JinnyAPI',
        baseUrl: 'Base URL',
        baseUrlPlaceholder: 'https://api.example.com',
        providerType: 'Provider Platform',
        providerTypeHint: 'Provider platform cannot be changed after creation',
        email: 'Login Email',
        emailPlaceholder: 'Email for the remote instance',
        password: 'Login Password',
        passwordPlaceholder: 'Password for the remote instance',
        notes: 'Notes',
      ...
      refreshRemote: 'Refresh Groups',
      linkAccount: 'Link Account',
      unlinkAccount: 'Unlink',
      optimizeAccount: 'Optimize Group',
      ...
      pathsDetected: 'Paths detected: Keys={keys}, Groups={groups}',
      pathsDetectFailed: 'Path detection failed',

      linkAccountTitle: 'Link Account to Provider',
      linkAccountDesc: 'Select a local account. The system will automatically match the corresponding APIKey on the remote instance.',
      ...
      unlinkConfirmMessage: 'Are you sure you want to unlink this account from the provider?',

      optimizing: 'Optimizing...',
      optimizeSuccess: 'Group optimized: {old} → {new} (rate {multiplier})',
      alreadyOptimal: 'Already optimal group',
      optimizeFailed: 'Optimization failed',
      optimizeAllTitle: 'Batch Optimization Results',
      optimizeAllSuccess: 'Batch optimization done: {success} optimized, {optimal} already optimal, {failed} failed',
      ...
      remoteKeyId: 'Remote Key ID',
      remoteGroup: 'Current Group',
      multiplier: 'Rate',
      syncedAt: 'Synced At',

      deleteConfirmMessage: "Delete provider '{name}'? Linked account associations will also be cleared.",

      apiPaths: 'API Paths',
      keysPath: 'Keys Path',
      groupsPath: 'Groups Path',
      pathsNotDetected: 'Not detected',
      pathsReady: 'Paths ready',
      pathsNotDetectedHint: 'Paths not detected — click More → Detect Paths so linking and optimization work',

      loadFailed: 'Failed to load providers',
      // Schedule optimize
      scheduleOptimize: 'Schedule Optimize',
      scheduleOptimizeTitle: 'Schedule Optimize Config',
      scheduleOptimizeDesc: 'Configure a scheduled task to automatically optimize account groups. The system will switch eligible accounts to lower-cost groups based on the cron schedule.',
      cronExpr: 'Cron Expression',
      cronExprPlaceholder: 'e.g. 0 2 * * * (daily at 2am)',
      cronPresets: {
        hourly: 'Hourly',
        daily2am: 'Daily 2am',
        daily6am: 'Daily 6am',
      ...
      neverRun: 'Never run',
      runNow: 'Run now',
      runNowSuccess: 'Schedule triggered, check logs shortly',
      runNowFailed: 'Trigger failed',
      scheduleSaved: 'Schedule config saved',
      scheduleDeleted: 'Schedule config deleted',
      scheduleLoadFailed: 'Failed to load schedule config',
      scheduleSaveFailed: 'Failed to save schedule config',
      deleteSchedule: 'Delete schedule',
      deleteScheduleConfirm: 'Are you sure you want to delete this schedule config?',
      recentLogs: 'Recent runs',
      noLogs: 'No run history',
      runningHint: 'Optimizing in background, results will refresh automatically...',
      logStatus: {
        success: 'Success',
        failed: 'Failed',
        partial: 'Partial',
      },
      logTotal: '{total} accounts',
      logOptimized: 'Optimized {count}',
      logSkipped: 'Skipped {count}',
      logFailed: 'Failed {count}',
      logDuration: 'took {duration}',
      detailStatus: {
        optimized: 'Optimized',
        skipped: 'Skipped',
        failed: 'Failed',
      ...
      // Account optimize settings
      joinScheduleHint: 'Enable to include this account in scheduled optimization with a max acceptable multiplier',
      joinScheduleOn: 'Participating in schedule, click to disable',
      joinScheduleOff: 'Not participating, click to enable',
      minMultiplier: 'Min Multiplier',
      minMultiplierHint: 'Skip groups cheaper than this value (avoids unstable oversold tiers); empty = no lower bound',
      maxMultiplier: 'Max Multiplier',
      maxMultiplierHint: 'Schedule will pick groups with multiplier ≤ this value; empty = skip',
      testModel: 'Test Model',
      testModelHint: 'Model used to verify connection after switching group',
      maxMultiplierInvalid: 'Max multiplier must be a number greater than 0',
      minMultiplierInvalid: 'Min multiplier must be a number ≥ 0',
      minMultiplierExceedsMax: 'Min multiplier must not exceed max multiplier',
      maxMultiplierRequired: 'Please set max multiplier before enabling schedule',
      minMultiplierRequired: 'Please set min multiplier before enabling schedule',
      testModelRequired: 'Please select test model before enabling schedule',
      optimizeAllIncomplete: 'The following accounts have incomplete settings (max/min/test model), please complete first: {accounts}',
