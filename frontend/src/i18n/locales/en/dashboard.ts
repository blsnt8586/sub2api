export default {
  ...
  keys: {
    ...
    apiKey: 'API Key',
    group: 'Group',
		smartGroupColumn: 'Routing group',
    ...
    namePlaceholder: 'My API Key',
		...
		fixedRouting: 'Fixed group',
		fixedGroupBadge: 'Fixed',
		smartRouting: 'Smart groups',
		fixedGroupDescription: 'Always route requests through one fixed group.',
		smartGroupLabel: 'Smart groups',
		smartGroupDescription: 'Automatically fail over across same-platform groups and recover to a cheaper rate after a stable period.',
		smartGroupSettings: 'Smart group settings',
		platformLabel: 'Platform',
		selectPlatform: 'Select a platform',
		selectPlatformFirst: 'Select a platform first',
		platformGroupCount: '{count} groups',
		platformRequired: 'Please select a platform',
		fixedGroupLabel: 'Fixed group',
		smartGroupCandidates: 'Candidate groups',
		smartGroupCandidatesHint: 'The number is the request priority, sorted by your effective rate. Saving immediately uses No. 1; every automatic switch is independently probed first.',
		smartGroupNoCandidates: 'No supported text groups are available',
		smartGroupFailureThreshold: 'Consecutive failures',
		smartGroupFailureThresholdHint: 'Probe the next candidate after this many failures.',
		smartGroupRecoveryMinutes: 'Stable check interval',
		smartGroupRecoveryMinutesHint: 'After the active group stays healthy this long, probe for a cheaper group.',
		smartGroupMinimum: 'Smart routing requires at least two groups on the same platform',
		smartGroupFailureThresholdError: 'Consecutive failures must be between 1 and 20',
		smartGroupRecoveryMinutesError: 'Stable check interval must be between 1 and 1440 minutes',
		smartGroupBadge: 'Smart {count}',
		smartGroupRuntimeHint: '{count} smart groups; consecutive failures {failures}/{threshold}',
		smartGroupPrimaryLabel: 'Preferred route',
		smartGroupPrimaryHint: 'No. 1 is sorted by the effective multiplier. Saving immediately makes it the active route without probing; failover and cheaper-group probes only run after real user requests meet the policy conditions.',
		smartGroupSwitchLogs: 'Smart switch logs',
		smartGroupSwitchLogsShort: 'Switch logs',
		smartGroupSwitchLogsDescription: 'Only successful automatic group switches from the last 3 days are shown.',
		smartGroupNoSwitchLogs: 'No smart switches in the last 3 days',
		smartGroupSwitchLogsLoadFailed: 'Failed to load smart switch logs',
		smartGroupSwitchReasonFailure: 'Failure failover',
		smartGroupSwitchReasonCostRecovery: 'Cost recovery',
    ...
    clickToChangeGroup: 'Click to change group',
		clickToManageSmartGroup: 'Click to manage smart groups',
