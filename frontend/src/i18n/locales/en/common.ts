export default {
  ...
  codexRadar: {
    ...
    intelligenceHint: 'Compare real public samples by model, effort, IQ, duration, and cost.',
    onlyComprehensive: 'The current source only provides comprehensive intelligence data.',
    tabs: {
      comprehensive: 'Comprehensive intelligence',
    ...
    samples: 'Samples', models: 'models', noData: 'No data',
    colModelEffort: 'Model / Effort', colDuration: 'Time', colCost: 'Cost',
    minutesShort: '{n}m',
    disclaimer: {
