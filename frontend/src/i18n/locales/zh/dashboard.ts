export default {
  ...
  keys: {
    ...
    namePlaceholder: '我的 API 密钥',
		...
		fixedGroupBadge: '固定',
		smartRouting: '智能分组',
		fixedGroupDescription: '请求始终使用一个固定分组。',
		smartGroupLabel: '智能分组',
		smartGroupDescription: '在多个同平台分组之间自动熔断，并在稳定后尝试切回更低倍率。',
		smartGroupSettings: '智能分组设置',
		platformLabel: '平台',
		selectPlatform: '选择平台',
		selectPlatformFirst: '请先选择平台',
		platformGroupCount: '{count} 个分组',
		platformRequired: '请选择平台',
		fixedGroupLabel: '固定分组',
		smartGroupCandidates: '候选分组',
		smartGroupCandidatesHint: '编号即请求优先级，按您的实际倍率从低到高排列。保存会立即使用编号 1；自动切换前会先进行独立探测。',
		smartGroupNoCandidates: '暂无支持智能路由的文本分组',
		smartGroupFailureThreshold: '连续失败次数',
		smartGroupFailureThresholdHint: '达到该次数后探测下一候选分组。',
		smartGroupRecoveryMinutes: '稳定检查时间',
		smartGroupRecoveryMinutesHint: '当前分组持续正常达到该时间后，探测是否有更便宜的分组。',
		smartGroupMinimum: '智能分组至少需要选择 2 个同平台分组',
		smartGroupFailureThresholdError: '连续失败次数必须在 1 到 20 之间',
		smartGroupRecoveryMinutesError: '稳定检查时间必须在 1 到 1440 分钟之间',
		smartGroupBadge: '智能 {count} 组',
		smartGroupRuntimeHint: '智能分组共 {count} 个；当前连续失败 {failures}/{threshold}',
		smartGroupPrimaryLabel: '首选路由',
		smartGroupPrimaryHint: '编号 1 是按实际倍率排序后的首选路由；保存后会立即作为当前路由，但不会因此主动探测。后续熔断和更便宜分组探测只在真实用户请求后触发。',
		smartGroupSwitchLogs: '智能切换日志',
		smartGroupSwitchLogsShort: '切换日志',
		smartGroupSwitchLogsDescription: '仅显示最近 3 天成功完成的自动分组切换记录。',
		smartGroupNoSwitchLogs: '最近 3 天暂无智能切换记录',
		smartGroupSwitchLogsLoadFailed: '加载智能切换日志失败',
		smartGroupSwitchReasonFailure: '故障熔断',
		smartGroupSwitchReasonCostRecovery: '低价恢复',
		selectGroup: '选择分组',
    statusLabel: '状态',
    selectStatus: '选择状态',
    saving: '保存中...',
    ...
    clickToChangeGroup: '点击更换分组',
		clickToManageSmartGroup: '点击管理智能分组',
