export default {
  ...
  codexRadar: {
    ...
    updatedAt: '更新于 {time}',
    groups: '个推荐组',
    intelligenceHint: '按模型、推理档位、IQ、耗时与费用对比真实公开样本。',
    onlyComprehensive: '当前数据源仅提供综合智能数据。',
    tabs: {
      comprehensive: '综合智能',
      software: '软件工程能力',
      visual: '视觉空间推理',
    ...
    samples: '样本', models: '个模型', noData: '暂无数据',
    colModelEffort: '模型 / 档位', colDuration: '耗时', colCost: '费用',
    minutesShort: '{n}分钟',
    disclaimer: {
      title: '第三方数据说明',
