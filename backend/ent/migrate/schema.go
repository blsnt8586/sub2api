...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "smart_group_enabled", Type: field.TypeBool, Default: false},
		{Name: "smart_group_ids", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "smart_group_failure_threshold", Type: field.TypeInt, Default: 3},
		{Name: "smart_group_recovery_interval_seconds", Type: field.TypeInt, Default: 900},
		{Name: "smart_group_consecutive_failures", Type: field.TypeInt, Default: 0},
		{Name: "smart_group_healthy_since", Type: field.TypeTime, Nullable: true},
		{Name: "smart_group_last_probe_at", Type: field.TypeTime, Nullable: true},
		{Name: "smart_group_last_switch_at", Type: field.TypeTime, Nullable: true},
		{Name: "smart_group_probe_lease_until", Type: field.TypeTime, Nullable: true},
		{Name: "smart_group_last_switch_reason", Type: field.TypeString, Size: 32, Default: ""},
		{Name: "smart_group_last_error", Type: field.TypeString, Default: "", SchemaType: map[string]string{"postgres": "text"}},
	...
	APIKeysTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{APIKeysColumns[21], APIKeysColumns[22]},
			},
			{
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "video_price_per_count", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		...
		{Name: "canvas_model_pricing", Type: field.TypeBytes, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
...
func init() {
	...
	AccountsTable.ForeignKeys[2].RefTable = Sub2apiProvidersTable
