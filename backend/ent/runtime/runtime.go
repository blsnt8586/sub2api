...
func init() {
	...
	// apikeyDescSmartGroupEnabled is the schema descriptor for smart_group_enabled field.
	apikeyDescSmartGroupEnabled := apikeyFields[5].Descriptor()
	// apikey.DefaultSmartGroupEnabled holds the default value on creation for the smart_group_enabled field.
	apikey.DefaultSmartGroupEnabled = apikeyDescSmartGroupEnabled.Default.(bool)
	// apikeyDescSmartGroupIds is the schema descriptor for smart_group_ids field.
	apikeyDescSmartGroupIds := apikeyFields[6].Descriptor()
	// apikey.DefaultSmartGroupIds holds the default value on creation for the smart_group_ids field.
	apikey.DefaultSmartGroupIds = apikeyDescSmartGroupIds.Default.([]int64)
	// apikeyDescSmartGroupFailureThreshold is the schema descriptor for smart_group_failure_threshold field.
	apikeyDescSmartGroupFailureThreshold := apikeyFields[7].Descriptor()
	// apikey.DefaultSmartGroupFailureThreshold holds the default value on creation for the smart_group_failure_threshold field.
	apikey.DefaultSmartGroupFailureThreshold = apikeyDescSmartGroupFailureThreshold.Default.(int)
	// apikeyDescSmartGroupRecoveryIntervalSeconds is the schema descriptor for smart_group_recovery_interval_seconds field.
	apikeyDescSmartGroupRecoveryIntervalSeconds := apikeyFields[8].Descriptor()
	// apikey.DefaultSmartGroupRecoveryIntervalSeconds holds the default value on creation for the smart_group_recovery_interval_seconds field.
	apikey.DefaultSmartGroupRecoveryIntervalSeconds = apikeyDescSmartGroupRecoveryIntervalSeconds.Default.(int)
	// apikeyDescSmartGroupConsecutiveFailures is the schema descriptor for smart_group_consecutive_failures field.
	apikeyDescSmartGroupConsecutiveFailures := apikeyFields[9].Descriptor()
	// apikey.DefaultSmartGroupConsecutiveFailures holds the default value on creation for the smart_group_consecutive_failures field.
	apikey.DefaultSmartGroupConsecutiveFailures = apikeyDescSmartGroupConsecutiveFailures.Default.(int)
	// apikeyDescSmartGroupLastSwitchReason is the schema descriptor for smart_group_last_switch_reason field.
	apikeyDescSmartGroupLastSwitchReason := apikeyFields[14].Descriptor()
	// apikey.DefaultSmartGroupLastSwitchReason holds the default value on creation for the smart_group_last_switch_reason field.
	apikey.DefaultSmartGroupLastSwitchReason = apikeyDescSmartGroupLastSwitchReason.Default.(string)
	// apikey.SmartGroupLastSwitchReasonValidator is a validator for the "smart_group_last_switch_reason" field. It is called by the builders before save.
	apikey.SmartGroupLastSwitchReasonValidator = apikeyDescSmartGroupLastSwitchReason.Validators[0].(func(string) error)
	// apikeyDescSmartGroupLastError is the schema descriptor for smart_group_last_error field.
	apikeyDescSmartGroupLastError := apikeyFields[15].Descriptor()
	// apikey.DefaultSmartGroupLastError holds the default value on creation for the smart_group_last_error field.
	apikey.DefaultSmartGroupLastError = apikeyDescSmartGroupLastError.Default.(string)
	// apikeyDescQuota is the schema descriptor for quota field.
	apikeyDescQuota := apikeyFields[19].Descriptor()
	...
	apikeyDescQuotaUsed := apikeyFields[20].Descriptor()
	...
	// sub2apiproviderprobeconfigDescAccountStatusSyncEnabled is the schema descriptor for account_status_sync_enabled field.
	sub2apiproviderprobeconfigDescAccountStatusSyncEnabled := sub2apiproviderprobeconfigFields[11].Descriptor()
	// sub2apiproviderprobeconfig.DefaultAccountStatusSyncEnabled holds the default value on creation for the account_status_sync_enabled field.
	sub2apiproviderprobeconfig.DefaultAccountStatusSyncEnabled = sub2apiproviderprobeconfigDescAccountStatusSyncEnabled.Default.(bool)
	// sub2apiproviderprobeconfigDescAccountStatusFailureThreshold is the schema descriptor for account_status_failure_threshold field.
	sub2apiproviderprobeconfigDescAccountStatusFailureThreshold := sub2apiproviderprobeconfigFields[12].Descriptor()
	// sub2apiproviderprobeconfig.DefaultAccountStatusFailureThreshold holds the default value on creation for the account_status_failure_threshold field.
	sub2apiproviderprobeconfig.DefaultAccountStatusFailureThreshold = sub2apiproviderprobeconfigDescAccountStatusFailureThreshold.Default.(int)
	// sub2apiproviderprobeconfig.AccountStatusFailureThresholdValidator is a validator for the "account_status_failure_threshold" field. It is called by the builders before save.
	sub2apiproviderprobeconfig.AccountStatusFailureThresholdValidator = sub2apiproviderprobeconfigDescAccountStatusFailureThreshold.Validators[0].(func(int) error)
	// sub2apiproviderprobeconfigDescAccountStatusRecoveryThreshold is the schema descriptor for account_status_recovery_threshold field.
	sub2apiproviderprobeconfigDescAccountStatusRecoveryThreshold := sub2apiproviderprobeconfigFields[13].Descriptor()
	// sub2apiproviderprobeconfig.DefaultAccountStatusRecoveryThreshold holds the default value on creation for the account_status_recovery_threshold field.
	sub2apiproviderprobeconfig.DefaultAccountStatusRecoveryThreshold = sub2apiproviderprobeconfigDescAccountStatusRecoveryThreshold.Default.(int)
	// sub2apiproviderprobeconfig.AccountStatusRecoveryThresholdValidator is a validator for the "account_status_recovery_threshold" field. It is called by the builders before save.
	sub2apiproviderprobeconfig.AccountStatusRecoveryThresholdValidator = sub2apiproviderprobeconfigDescAccountStatusRecoveryThreshold.Validators[0].(func(int) error)
