...
type APIKey struct {
	...
	SmartGroupHealthySince            *time.Time `json:"smart_group_healthy_since"`
	SmartGroupLastProbeAt             *time.Time `json:"smart_group_last_probe_at"`
	SmartGroupLastSwitchAt            *time.Time `json:"smart_group_last_switch_at"`
	SmartGroupLastSwitchReason        string     `json:"smart_group_last_switch_reason"`
	SmartGroupLastError               string     `json:"smart_group_last_error"`
