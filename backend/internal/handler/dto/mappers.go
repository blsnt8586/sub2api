...
func APIKeyFromService(k *service.APIKey) *APIKey {
	...
	out := &APIKey{
		...
		GroupID:                           k.GroupID,
		Status:                            k.Status,
		SmartGroupEnabled:                 k.SmartGroupEnabled,
		SmartGroupIDs:                     k.SmartGroupIDs,
		SmartGroupFailureThreshold:        k.SmartGroupFailureThreshold,
		SmartGroupRecoveryIntervalSeconds: k.SmartGroupRecoveryIntervalSeconds,
		SmartGroupConsecutiveFailures:     k.SmartGroupConsecutiveFailures,
		SmartGroupHealthySince:            k.SmartGroupHealthySince,
		SmartGroupLastProbeAt:             k.SmartGroupLastProbeAt,
		SmartGroupLastSwitchAt:            k.SmartGroupLastSwitchAt,
		SmartGroupLastSwitchReason:        k.SmartGroupLastSwitchReason,
		SmartGroupLastError:               k.SmartGroupLastError,
...
func groupFromServiceBase(g *service.Group) Group {
	return Group{
		...
		VideoPricePerCount:              g.VideoPricePerCount,
		...
		CanvasImagePricePerCount:        g.CanvasImagePricePerCount, // [CUSTOM]
		CanvasAudioPricePerCount:        g.CanvasAudioPricePerCount, // [CUSTOM]
		CanvasModelPricing:              g.CanvasModelPricing,       // [CUSTOM] canvas
