...
func (s *OpenAIGatewayService) RecordUsage(ctx context.Context, input *OpenAIRecordUsageInput) error {
	...
	if apiKey.GroupID != nil && apiKey.Group != nil {
		...
		multiplier = apiKey.Group.ApplyDynamicPricingFloor(multiplier)
	}
...
func groupMediaPricingLooksIncomplete(group *Group) bool {
	...
	if len(group.ModelPricing) > 0 || group.LongContextPricingEnabled ||
		group.CanvasModelPricing != nil || group.CanvasImagePricePerCount != nil || group.CanvasAudioPricePerCount != nil {
		return false
	}
