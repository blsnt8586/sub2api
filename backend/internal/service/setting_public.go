...
func (s *SettingService) GetPublicSettings(ctx context.Context) (*PublicSettings, error) {
	keys := []string{
		...
		SettingKeyCodexRadarEnabled, // [CUSTOM]
	...
	return &PublicSettings{
		...
		CodexRadarEnabled:     settings[SettingKeyCodexRadarEnabled] == "true", // [CUSTOM]
...
// IsCodexRadarEnabled reads the [CUSTOM] Codex-radar feature switch directly from the
// settings store. Fail-closed: on error returns false (opt-in, third-party data source).
...
type PublicSettingsInjectionPayload struct {
	...
	CodexRadarEnabled            bool `json:"codex_radar_enabled"` // [CUSTOM]
...
func (s *SettingService) GetPublicSettingsForInjection(ctx context.Context) (any, error) {
	...
	return &PublicSettingsInjectionPayload{
		...
		CodexRadarEnabled:                    settings.CodexRadarEnabled, // [CUSTOM]
