...
func (s *adminServiceImpl) CreateGroup(ctx context.Context, input *CreateGroupInput) (*Group, error) {
	...
	group := &Group{
		...
		VideoPricePerCount:              videoPricePerCount,
		...
		CanvasModelPricing:              normalizeModelPricing(input.CanvasModelPricing), // [CUSTOM] canvas
...
func (s *adminServiceImpl) UpdateGroup(ctx context.Context, id int64, input *UpdateGroupInput) (*Group, error) {
	...
	if input.CanvasModelPricing != nil {
		group.CanvasModelPricing = normalizeModelPricing(input.CanvasModelPricing)
	}
