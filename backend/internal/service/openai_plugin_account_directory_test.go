...
func TestAccountReadableSnapshot_DenylistTripwire(t *testing.T) {
	...
	safeToExpose := map[string]struct{}{
		...
		// Provider linkage stores numeric IDs and policy metadata, never credentials.
		"ProviderID": {}, "ProviderAPIKeyID": {}, "RemoteGroupID": {},
		"RemoteGroupName": {}, "RemoteGroupMultiplier": {}, "RemoteGroupSyncedAt": {},
		"Sub2APIOptimizeEnabled": {}, "Sub2APIMinMultiplier": {}, "Sub2APIMaxMultiplier": {},
		"Sub2APITestModel": {}, "Sub2APIOptimizeGroupID": {}, "Sub2APIOptimizeGroupIDs": {},
	}
